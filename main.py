...
if __name__ == '__main__':
    ...
    RunPoint(move,[262.21,35.58,-181.27,11.56])
    RunPoint(move,[364.18,77.49,-181.27,11.56])
    RunPoint(move,[319.05,-47.66,-87.9,11.56])
    # RunPoint(move,[259.5,108,-60,140])
    # print(res)
    # while True:
